...
Issues that involve feature requests will be resolved according to feasibility and amount of votes: [`is:issue is:open priority sort:reactions-+1-desc`](https://github.com/UnofficialCrusaderPatch/UnofficialCrusaderPatch3/issues?q=is%3Aissue+is%3Aopen+priority+sort%3Areactions-%2B1-desc)
