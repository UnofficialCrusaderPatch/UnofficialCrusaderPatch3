...
local healer_find_code = {
  ...
  0xE8, function(index) return itob(getRelativeAddress(index, distfunc, -5 + 1)) end,         --  - call 0046CC80.
  ...
  0xE8, function(index) return itob(getRelativeAddress(index, GetRandomShort, -5 + 1)) end, -- call getrandomshort.
...
local hook_address = insertCode(o_healer_find_address, 5, {
  ...
  0x0F, 0x84, function(index) return itob(getRelativeAddress(index, healer_find_address, -6 + 2)) end, -- je
